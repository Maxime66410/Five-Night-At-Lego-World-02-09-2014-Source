...
if(doorLbutton.GetComponent(DoorButton).opened) { newDoorLcounter = 1; }
if(!doorLbutton.GetComponent(DoorButton).opened) { newDoorLcounter = 0; }

if(doorRbutton.GetComponent(DoorButton).opened) { newDoorRcounter = 1; }
if(!doorRbutton.GetComponent(DoorButton).opened) { newDoorRcounter = 0; }
...
if(doorRbutton.GetComponent(DoorButton).opened) //!
{
battery -= Time.deltaTime/* * usageCounter*/;
}
